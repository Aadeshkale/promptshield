...
class CloudflareClassifier(BaseClassifier):

    PATTERNS = {
        "CLOUDFLARE_GLOBAL_API_KEY": {
            "secret_type": "CLOUDFLARE_GLOBAL_API_KEY",
            "base_confidence": 0.30,
            "base_specificity": 60,
            "replacement": "<CLOUDFLARE_GLOBAL_API_KEY>",
        },
    ...
    CONTEXT_KEYWORDS = [
        "cloudflare", "cf_", "cloudflare_api", "email",
    ]
