...
class CredentialsClassifier(BaseClassifier):
    ...
    PATTERNS = {
        "PASSWORD_ASSIGNMENT": {
            ...
            "base_specificity": 70,
            "replacement": "<HARDCODED_PASSWORD>",
        },
        "USERNAME_ASSIGNMENT": {
            "secret_type": "HARDCODED_USERNAME",
            "base_confidence": 0.30,
            "base_specificity": 40,
            "replacement": "<HARDCODED_USERNAME>",
        },
        "BASIC_AUTH_URL": {
            "secret_type": "BASIC_AUTH_URL",
            "base_confidence": 0.70,
            "base_specificity": 90,
            "replacement": "<BASIC_AUTH_URL>",
        },
    }

    CONTEXT_KEYWORDS = [
        "password", "passwd", "pwd", "user", "username", "login",
        "secret", "credentials", "auth", "connection",
    ]
